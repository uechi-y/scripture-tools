...
const VERSE_COUNT: { [key: string]: number[] } = {
    "jarom": [15],
    "john": [
    ...
    "3-jn": [14],
    "omni": [30],
    "hel": [34, 14, 37, 26, 52, 41, 29, 28, 41, 19, 38, 26, 39, 31, 17, 25],
    "2-kgs": [
    ...
    "3-ne": [
        30, 19, 26, 33, 26, 30, 26, 25, 22, 19, 41, 48, 34, 27, 24, 20, 25, 39,
        36, 46, 29, 17, 14, 18, 6, 21, 33, 40, 9, 2
    ],
    "enos": [27],
    "mosiah": [
    ...
    "alma": [
        33, 38, 27, 20, 62, 8, 27, 32, 34, 32, 46, 37, 31, 29, 19, 21, 39, 43,
        36, 30, 23, 35, 18, 30, 17, 37, 30, 14, 17, 60, 38, 43, 23, 41, 16, 30,
        47, 15, 19, 26, 15, 31, 54, 24, 24, 41, 36, 25, 30, 40, 37, 40, 23, 24,
        35, 57, 36, 41, 13, 36, 21, 52, 17
    ],
    ...
    "1-jn": [10, 29, 24, 21, 21],
    "2-ne": [
        32, 30, 25, 35, 34, 18, 11, 25, 54, 25, 8, 22, 26, 6, 30, 13, 25, 22,
        21, 34, 16, 6, 22, 32, 30, 33, 35, 32, 14, 18, 21, 9, 15
    ],
    "w-of-m": [18],
    ...
    "morm": [19, 29, 22, 23, 24, 22, 10, 41, 37],
    "2-chr": [
